...
urlpatterns = [
    ...
    path("api/", RedirectView.as_view(url="/api/v1/", permanent=True, query_string=True)),
    path("api/<path:rest>", RedirectView.as_view(url="/api/v1/%(rest)s", permanent=True, query_string=True)),
